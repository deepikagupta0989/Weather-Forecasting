...
const TempAndDetail = ({
  ...
  return (
    <div>
      <div className='flex justify-center items-center py-6 text-cyan-300'>
        <p>{details}</p>
      </div>
      ...
      <div className='flex flex-row space-y-3  items-center justify-center space-x-10 text-sm py-3'>
        {
